...
def get_sample_split(nusc: NuScenes, sample_token: str) -> str:
    ...
    """
    # The cached traj data spans full trainval; when nusc is a subset (e.g.
    # v1.0-mini) tokens outside it are simply not in this split.
    if sample_token not in nusc._token2ind["sample"]:
        return "unknown"
