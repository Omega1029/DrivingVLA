...
% ============================================================================
% ICLR 2027 submission -- single column, 9 pages main text (refs/appendix free).
% Swap this preamble for iclr2027_conference.sty before submitting; the body is
% written to be style-agnostic. MUST be anonymised (no author block) and MUST
% carry the mandatory AI-usage disclosure section.
%
...
%   manipulation           -> OpenVLA-OFT / LIBERO pipeline (separate harness)
% ============================================================================
...
% ICLR 2027 requires this section; it does not count toward the page limit. Fill in per the
% AI Policy for Authors before submission.
\emph{To be completed per ICLR 2027 policy.}
